...
declare namespace React {
  ...
  > = ReactElement<P, Exclude<T, number>>
  ...
  type ReactHTMLElement<T extends HTMLElement> = DetailedReactHTMLElement<
    AllHTMLAttributes<T>,
    T
  >
  ...
  type HTMLFactory<T extends HTMLElement> = DetailedHTMLFactory<
    AllHTMLAttributes<T>,
    T
  >
